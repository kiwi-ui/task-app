        ...
        <div className='rounded-3 position-absolute w-50' style={{zIndex: 10}}>
            <div className='container'>
                <ul className="list-group bg-white">
                    ...
                    <li className="list-group-item d-flex flex-row gap-3 align-items-center"><AiOutlineArrowLeft className='option-icon'/> <span className="option-text">Move Left</span></li>
